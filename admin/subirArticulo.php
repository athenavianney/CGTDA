...
<html lang="en">
  ...
  <body>
    ...
    <form action="registroArticulo.php"  method="post">
      <div class="card rounded-0">
        <div class="card-header">
            <h3 class="mb-0">Subir Artículo</h3>
        </div>
        <!-- Data input-->
        <div class="card-body">
          <div class="form-group">
            ...
            <input class="form-control" type="text" name="colaboradores">
            <label for="lenguaje">Fecha de publicación:</label>
