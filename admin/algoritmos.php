  ...
  <body>
    ...
    <div class="card rounded-0">
      <div class="card-header">
        <h3 class="mb-0">Editar Algoritmo</h3>
      </div>
      <div class="card-body">
        <div class="row">
          <?php
            $path = "SELECT * FROM algoritmo";
            ...
            while ($row = $result->fetch_assoc()) {
              ...
              <p class='font-weight-light'>$row[autores]</p>        
              </div>";

              echo "
              <div class='col-md-2'>
                <p class='font-weight-normal'>Lenguaje</p>
              <p class='font-weight-light'>$row[lenguaje]</p>        
              </div>";

              echo"
              <div class='col-md-0'>
                <a href='editarAlgoritmo.php?id=$idc' class='font-weight-normal'>Eliminar</a>
              </div>";
            }
          ?>
      </div>  
